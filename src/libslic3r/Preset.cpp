...
static std::vector<std::string> s_Preset_print_options {
    ...
    "flush_into_infill", "flush_into_objects", "flush_into_support",
     ...
     "wipe_tower_cone_angle", "wipe_tower_extra_spacing","wipe_tower_max_purge_speed","wipe_tower_first_layer_flow_rate", "wipe_tower_extruder", "wiping_volumes_extruders","wipe_tower_bridging", "single_extruder_multi_material_priming",
