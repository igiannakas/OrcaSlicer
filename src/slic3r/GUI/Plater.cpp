...
auto print_config = &wxGetApp().preset_bundle->prints.get_edited_preset().config;
    ...
    for (auto _obj : objects) {
        ...
        _obj->config.set_key_value("second_internal_bridge_over_infill", new ConfigOptionBool(false));
        _obj->config.set_key_value("second_external_bridge", new ConfigOptionBool(false));
